...
insert into TEAM (id, name, logo, blog, charterCompleted,  TEAM_CHARTER_id, CLASS_id ) values (1, 'DRE', 'http://dummyimage.com/238x127.jpg/ff4444/ffffff', 'www.blogger.com', false, 2, 1);
insert into TEAM (id, name, logo, blog, charterCompleted,  TEAM_CHARTER_id, CLASS_id ) values (2, 'RED', 'https://www.colourbox.com/preview/18264436-vector-red-word-lettering.jpg', 'www.wordpress.com', true, 1, 1);
insert into SPRINT (id, sprint_number, start_date, end_date, scrum_master, scribe, info, TEAM_id) values (1, 1, '2016-04-19 22:02:37', '2017-09-23 16:04:27', 'Corette Boschmann', 'Pepita Sambrok', 'Move robot 3 feet and test ping sensor.', 2);
...
insert into MBDForm (id, More, Better, Different,STUDENT_id) values (10, 'Our communication could be done better throughout the sprint to be able to hit the deadline in time.', 'I can improve my time management.', 'My tendency to procrastinate hindered my progress.', 11);
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (1, 'Smith', 'Bob', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I like communicating face to face.', 'Pyrotechnics, basic wiring. ', 'C++', 1, 2, 'bthyng0@discovery.com', 1, 'tristique', 'aRDjM8zcVej', 'Electrical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (2, 'Nguyen', 'Tim', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I like to work in groups. ', 'Current events in Africa, how to test turbidity.', 'Java', 1, 1, 'eostrich1@senate.gov', 2, 'quam', 'qbuwlw6yaq', 'Environmental');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (3, 'Silvano', 'Price', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I like leading teams.', 'Build computers, loves animals. ', 'Sautering', 1, 2, 'sprice2@dell.com', 3, 'cras', '0GvukLN4aKQ', 'Computer Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (4, 'Mahmud', 'Townes', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I like overcoming obstacles.', 'World War II weapons', 'Haskell', 1, 1, 'mtownes3@oakley.com', 4, 'et', 'VParvZYrjI', 'Electrical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (5, 'Auguste', 'Ellie', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I don\'t like when people tell me to do stuff.', 'History of bridges.', 'Swift', 1, 1, 'aestoile4@prnewswire.com', 5, 'sit', 'LB9Qp3E6', 'Civil Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (6, 'Holt', 'Will', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I am goal oriented and like direction.', 'Arduino sensors and outputs.', 'Python', 1, 1, 'htarbin5@barnesandnoble.com', 6, 'volutpat', 'dDiuIC6', 'Electrical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (7, 'Kim', 'Alan', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I dislike being the center of attention.', 'CAD, 3D printing.', 'Go', 1, 2, 'lwrightam6@eventbrite.com', 7, 'augue', 'b6p9yEOryO', 'Mechanical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (8, 'Dewey', 'Tony', 'https://cdn.vectorstock.com/i/thumb-large/48/33/10704833.jpg', 'I am extroverted.', 'Coding. Excel.', 'C', 1, 1, 'dendrizzi7@facebook.com', 8, 'justo', 'HSlP z69duJ5G', 'EMIS');
...
insert into TEAM_CHARTER (id, ideating, decision_making, disputes, conflicts, fun, team_purpose, stakeholders, mission, TEAM_id) values (1, 'Team will vote on ideas and vote on the ones they see best and always willing to change. ',
  'Each person gets one vote and ties will be broken by Scrum Master.',
  'We will utilize face to face communication.',
  'We take it to Fontenot. It will be resolved by HCEL, the intermediary.',
  'We like to hang out casually for lunch or dinner while taking breaks for project.',
  'To solve a problem regarding environmental issues in various countries. ',
  'The team that relies on the grade, the professor that assigns the grade, the HART Cetner that has a vested
  team dynamics.',
  'To solve engineering problems that benefits our team members by also helping society, nisl.', 2);
...
insert into STAFF (id, admin, last_name, first_name, hash, salt, email) values (1, 1, 'Kathy', 'Hubbard', '7ae7fe8c91483423441ce20769806494448b6fa7', 'porttitor', 'wcrop0@weibo.com');
insert into STAFF (id, admin, last_name, first_name, hash, salt, email) values (2, 0, 'Spitell', 'Vikky', 'ac070f6574ae04bd942b6b47806d462770d37096', 'dictumst', 'vmcgroarty1@apple.com');
insert into STAFF (id, admin, last_name, first_name, hash, salt, email) values (3, 0, 'Cookson', 'Biddy', '72cce212cfce41b21329933c28a98e835a3fa22c', 'vitae', 'bpaszak2@fda.gov');
insert into STAFF (id, admin, last_name, first_name, hash, salt, email) values (4, 0, 'Fontenot', 'Mark', '72cce212cfce41b21329933c28a98e835a3fa22c', 'vitae', 'bpaszak2@fda.gov');
...
insert into ANNOUNCEMENTS (title, body, create_datetime, priority, creator, id, STAFF_id) values ('Finish MBD Form', 'Please finish the MBD Form by 5 pm.', '2016-09-08 09:29:30', 1, 'David Howell', 1, 1);
insert into ANNOUNCEMENTS (title, body, create_datetime, priority, creator, id, STAFF_id) values ('Complete Team Charter', 'Please complete your team charter by 7 pm.', '2017-01-05 10:05:39', 2, 'Larry Sims', 2, 2);
insert into ANNOUNCEMENTS (title, body, create_datetime, priority, creator, id, STAFF_id) values ('Edit to-do list', 'Don\'t forget to edit your sprint to do list.', '2016-11-12 23:55:19', 3, 'Kathleen Hansen', 3, 3);
insert into ANNOUNCEMENTS (title, body, create_datetime, priority, creator, id, STAFF_id) values ('Attached Reading', 'Don\t forget to do the reading by next Wednesday.', '2017-02-09 17:22:24', 4, 'Diana Morris', 4, 1);
insert into EVENTS (id, title, start_date, end_date, creator, description, location, STAFF_id, create_date, TEAM_id) values (1, 'Meeting 1', '2017-08-26', '2017-08-27', 'Jimmy Black', 'Sprint 1 Meeting', '8 Talisman Hill', 1, '2015-03-21', 2);
insert into EVENTS (id, title, start_date, end_date, creator, description, location, STAFF_id, create_date, TEAM_id) values (2, 'Meeting 2', '2017-08-28', '2017-08-29', 'Carol Fields', 'Sprint 2 Meeting', '2 Dawn Drive', 2, '2015-01-08', 2);
insert into EVENTS (id, title, start_date, end_date, creator, description, location, STAFF_id, create_date, TEAM_id) values (3, 'Meeting 3', '2017-09-05', '2017-09-06', 'Martin Rogers', 'Sprint 3 Meeting', '45 Hoffman Parkway', 3, '2015-01-13', 2);
insert into EVENTS (id, title, start_date, end_date, creator, description, location, STAFF_id, create_date, TEAM_id) values (4, 'Meeting 4', '2017-09-20', '2017-09-21', 'Annie Richards', 'Sprint 4 Meeting', '31517 Banding Plaza', 1, '2014-07-12', 2);
insert into EVENTS (id, title, start_date, end_date, creator, description, location, STAFF_id, create_date, TEAM_id) values (5, 'Meeting 5', '2017-09-26', '2017-09-27', 'Ann Robertson', 'Sprint 5 Meeting', '6233 Fordem Drive', 2, '2014-08-12', 2);
insert into EVENTS (id, title, start_date, end_date, creator, description, location, STAFF_id, create_date, TEAM_id) values (6, 'Meeting 6', '2017-10-20', '2017-10-21', 'Douglas Rice', 'Sprint 6 Meeting', '0206 Magdeline Point', 3, '2014-05-12', 2);
