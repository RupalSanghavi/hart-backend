...
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (1, 'Smith', 'Bob', 'in', 'I like communicating face to face.', 'Pyrotechnics, basic wiring. ', 'C++', 1, 2, 'bthyng0@discovery.com', 1, 'tristique', 'aRDjM8zcVej', 'Electrical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (2, 'Nguyen', 'Tim', 'nec', 'I like to work in groups. ', 'Current events in Africa, how to test turbidity.', 'Java', 1, 1, 'eostrich1@senate.gov', 2, 'quam', 'qbuwlw6yaq', 'Environmental');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (3, 'Silvano', 'Price', 'consequat', 'I like leading teams.', 'Build computers, loves animals. ', 'Sautering', 1, 2, 'sprice2@dell.com', 3, 'cras', '0GvukLN4aKQ', 'Computer Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (4, 'Mahmud', 'Townes', 'augue', 'I like overcoming obstacles.', 'World War II weapons', 'Haskell', 1, 1, 'mtownes3@oakley.com', 4, 'et', 'VParvZYrjI', 'Electrical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (5, 'Auguste', 'Ellie', 'blandit', 'I don\'t like when people tell me to do stuff.', 'History of bridges.', 'Swift', 1, 1, 'aestoile4@prnewswire.com', 5, 'sit', 'LB9Qp3E6', 'Civil Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (6, 'Holt', 'Will', 'felis', 'I am goal oriented and like direction.', 'Arduino sensors and outputs.', 'Python', 1, 1, 'htarbin5@barnesandnoble.com', 6, 'volutpat', 'dDiuIC6', 'Electrical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (7, 'Kim', 'Alan', 'scelerisque', 'I dislike being the center of attention.', 'CAD, 3D printing.', 'Go', 1, 2, 'lwrightam6@eventbrite.com', 7, 'augue', 'b6p9yEOryO', 'Mechanical Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (8, 'Dewey', 'Tony', 'vestibulum', 'I am extroverted.', 'Coding. Excel.', 'C', 1, 1, 'dendrizzi7@facebook.com', 8, 'justo', 'HSlP z69duJ5G', 'EMIS');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (9, 'Christian', 'MacMenamin', 'I like to solve problems in creative ways. ', 'Arduino, circuit board making.', 'JavaScript', 'in porttitor pede justo eu massa', 1, 1, 'cmacmenamin8@alexa.com', 9, 'in', 'lkTGIihVfjZV', 'Computer Engineering');
insert into STUDENT (id, first_name, last_name, image, info, knowledge, skills_abilities, CLASS_id, TEAM_id, email, MBDForm_id, salt, hash, major) values (10, 'Walden', 'Hendrikse', 'sit', 'I like to analyze. ', 'Battlebots', 'Fortran, Rust', 1, 2, 'whendrikse9@si.edu', 10, 'hac', 'EgrR8Qqonn', 'Computer Engineering');
